...
//
//     final routesUrban = routesUrbanFromJson(jsonString);

import 'dart:convert';

List<RoutesUrban> routesUrbanFromJson(String str) => List<RoutesUrban>.from(json.decode(str).map((x) => RoutesUrban.fromJson(x)));

String routesUrbanToJson(List<RoutesUrban> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RoutesUrban {
    ...
    factory RoutesUrban.fromJson(Map<String, dynamic> json) => RoutesUrban(
